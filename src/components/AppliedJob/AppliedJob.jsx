...
const AppliedJob = ({job}) => {
    ...
    return (
        <div className='border rounded-md p-5 mb-5 lg:flex items-center'>

            <div className='bg-[#ccc] px-6 py-6 h-[100px] w-[150px] lg:h-[200px] lg:w-[200px] flex items-center justify-center rounded-md'>
                <img className='' src={company_logo} alt="" />
            </div>

            <div className='lg:flex-grow lg:pl-10'>
